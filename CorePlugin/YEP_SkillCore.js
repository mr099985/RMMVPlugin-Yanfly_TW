 ...
 * 武器、盔甲及狀態注釋 :
 *   <Swap Gauge x: y>
 *   擁有裝備或包含這些注釋狀態的角色，或有這些注釋狀態的敵人，將顯示那些變更過
 *   後的量條，以代替預設設定或由「類別』或「敵人」注釋的設定。
 *
 *   優先順序如下排列：
 *     武器、盔甲、狀態、類別、敵人
 *
 ...
 * ============================================================================
 *
 * 對於希望更好控制技能消耗和技能效果的作者，有注釋可將程式碼使用於技能的消耗或
 * 效果。對於效果，這將擴展到道具控制。
 *
 ...
 * ============================================================================
 *
 * 對於那些想顯示某些技能並使用 JavaScript 知識在任何自定義條件下將其禁止使用的
 * 作者，請使用以下命令：
 *
 * 技能注釋 :
 *   <Custom Show Eval>
 ...
 * ============================================================================
 *
 * 對於那些有一定 JavaScript 經驗的人，您可以使用以下注釋來限制一個技能以及執行
 * 該技能時要處理的程式碼類型。
 *
 * 技能注釋 :
 *
